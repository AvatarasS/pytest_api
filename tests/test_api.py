...
class TestBookstoreAPI:
    ...
    def test_request_non_existent_book_type(self) -> None:
        ...
        response_content = json.loads(response.content)
        assert response_content["error"] == "Invalid value for query parameter 'type'. Must be one of: fiction, non-fiction."
    ...
    def test_submit_new_book_order(self) -> None:
        ...
        write_to_file(data_file, "orderId", response_content["orderId"])
